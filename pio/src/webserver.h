...
const char HTTP_HEAD_HTML[] PROGMEM = "<!DOCTYPE html><html lang=\"en\"><head><meta name=\"viewport\" charset=\"utf-8\" content=\"width=device-width, initial-scale=1, user-scalable=no\"/><title>{v}</title>";
...
const char ajaxRefresh[] PROGMEM =
...
const char HTTP_FORM_LIST[] PROGMEM = "<select id=\"{i}\" name=\"{n}\" placeholder=\"{p}\">";
